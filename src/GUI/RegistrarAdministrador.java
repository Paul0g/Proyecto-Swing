...
String confirmarPass = jTextField4.getText().trim();

if (nombre.isEmpty() || correo.isEmpty() || pass.isEmpty() || confirmarPass.isEmpty()) {
...
try (FileWriter fw = new FileWriter("administradores.txt", true)) {
